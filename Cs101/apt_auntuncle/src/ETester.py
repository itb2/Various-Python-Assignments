        ...
        def work(self):
                ...
                try:
                        while True:
                                ...
                                def inner():
                                        try:
                                                self.result = AuntUncle.aulist(copy.copy(a),copy.copy(b))
                                ...
                                expected = p.matchStringList(self.result)
                                ...
                                if not self.done or not self.resultReturned or not self.typeOk:
                                        ...
                                        if self.runtime:
                                                ...
                                                sprinter.write("expected <xmp>"+str(types.ListType)+"</xmp>")
                                        else:
