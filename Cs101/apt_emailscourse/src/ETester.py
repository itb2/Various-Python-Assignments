        ...
        def work(self):
                ...
                try:
                        while True:
                                ...
                                def inner():
                                        try:
                                                self.result = EmailsCourse.emailsLargest(copy.copy(a))
                                ...
                                self.typeOk = type(self.result) == types.StringType
                                expected = p.matchString(self.result)
                                ...
                                if not self.done or not self.resultReturned or not self.typeOk:
                                        ...
                                        if self.runtime:
                                                ...
                                                sprinter.write("expected <xmp>"+str(types.StringType)+"</xmp>")
                                        else:
